...
struct CodexAlertCLI {
    ...
    Usage:
      ...
      codex-alert ask --title "Proceed?" --body "Should I continue with the risky fix?" [--sender Codex] [--task "Task name"] [--project "Project name"] [--urgency high] [--wait] [--timeout-seconds 1800]
