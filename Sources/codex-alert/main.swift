...
struct CodexAlertCLI {
    ...
    Usage:
      ...
      codex-alert ask --title "Proceed?" --body "Should I continue with the risky fix?" [--sender Codex] [--task "Task name"] [--project "Project name"] [--urgency high] [--option "yes"] [--option "no"] [--option "later"] [--wait] [--timeout-seconds 1800] [--follow-up-after-seconds 300] [--follow-up-title "Question still waiting"] [--follow-up-body "The earlier question is still unanswered."]
